...
data_MCSselection_G1, data_MCSselection_G2, ds_T_I_G1, ds_T_I_G2, ds_T_E_G1, ds_T_E_G2 = separate_data_MCS(data, iregion)
...
for wave in wave_SEL :	
    ...
    print('OLR nombre de MCSs : ' + str(nb_MCS_1 + nb_MCS_2) + ' nb_MCS < 5H = ' + str(nb_MCS_1) + ' nb_MCS > 5H = ' + str(nb_MCS_2) + '\n')
    ...
    ax.set_rmax(0.06)
    plt.legend()
    plt.savefig(outfig + region + '_initiation_' + wave + '_OLR_sup5H_TEST.png')
    plt.close()
    ...
    ax.set_rmax(0.06)
    plt.legend()
    plt.savefig(outfig + region + '_nbMCS_' + wave + '_OLR_sup5H.png')
    plt.close()
    """
    ...
    print('TCWV nombre de MCSs : ' + str(nb_MCS_1 + nb_MCS_2) + ' nb_MCS < 5H = ' + str(nb_MCS_1) + ' nb_MCS > 5H = ' + str(nb_MCS_2) + '\n')
    """
    ### Compute nb of MCS in an active wave
    for iMCS in np.arange(0,len(data_MCSselection_G2),1):
        for ilife in np.arange(0,data_MCSselection_G2[iMCS].nbslot,1,dtype=int):
    ...
    ax.set_rmax(0.06)
    plt.legend()
    plt.savefig(outfig + region + '_initiation_' + wave + '_TCWV_sup5H.png')
    plt.close()
    ...
    ax.set_rmax(0.06)
    plt.legend()
    plt.savefig(outfig + region + '_nbMCS_' + wave + '_TCWV_sup5H.png')
    plt.close()
    """
    #########################################################################
    ...
    print('div 850 nombre de MCSs : ' + str(nb_MCS_1 + nb_MCS_2) + ' nb_MCS < 5H = ' + str(nb_MCS_1) + ' nb_MCS > 5H = ' + str(nb_MCS_2) + '\n')
    ...
    ax.set_rmax(0.06)
    plt.legend()
    plt.savefig(outfig + region + '_initiation_' + wave + '_div850_sup5H.png')
    plt.close()
    ...
    ax.set_rmax(0.06)
    plt.legend()
    plt.savefig(outfig + region + '_nbMCS_' + wave + '_div850_sup5H.png')
    plt.close()
    """
    #########################################################################
    ...
    #### Load Parameter for MCS and TOOCAN
    p_distri_G1, p_distri_G2, nb_MCS_1, nb_MCS_2, surface_G1, TbMin_G1, surface_G2, TbMin_G2 = \
                        calcul_Proba_wave(ds, ds_T_I_G1, ds_T_E_G1, data_MCSselection_G1, ds_T_I_G2, ds_T_E_G2, data_MCSselection_G2, 'init', varFiltre)
    print('div 200 nombre de MCSs : ' + str(nb_MCS_1 + nb_MCS_2) + ' nb_MCS < 5H = ' + str(nb_MCS_1) + ' nb_MCS > 5H = ' + str(nb_MCS_2) + '\n')
    ...
    ax.set_rmax(0.06)
    plt.legend()
    plt.savefig(outfig + region + '_initiation_' + wave + '_div200_sup5H.png')
    plt.close()
    ...
    ax.set_rmax(0.06)
    plt.legend()
    plt.savefig(outfig + region + '_nbMCS_' + wave + '_div200_sup5H.png')
    plt.close()
    """  
