...
name_text = '/cnrm/tropics/commun/DATACOMMUN/WAVE/NO_SAVE/DATA/ANALYSIS_TOOCAN/Distribution/data_MCS_' + zone + '.txt'
...
for name_phase in phase_sel :
    ...
    for wave in wave_SEL :	
        ...
        ### save numpy array
        save_file = np.stack((nb_occu, p_distri_G1, p_distri_G2, surface_G1, TbMin_G1, surface_G2, TbMin_G2))
        outfile = folder_out + region + '_nbMCS_' + wave + '_' + phase_p[k] + '_life.npy'
        np.save(outfile, save_file)
